...
const OHSRiskManagementSubmenu = () => {
    ...
    const categories = [
        ...
        },
        {
            ...
            label: "Occupational Health & Safety Hazards",
            icon: (
    ...
    const handleCategoryClick = (category) => {
        if (props && props.handleItemClick) {
            props.handleItemClick(category.id, category.path, "ohsriskmanagement");
        } else {
...
export default OHSRiskManagementSubmenu
