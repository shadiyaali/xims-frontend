    ...
    return (
        <div className="bg-[#1C1C24]">
            ...
            <div className="flex justify-between items-center add-user-header">
                ...
                <button
                    className="list-user-btn duration-200 border border-[#F310FF] text-[#F310FF] hover:bg-[#F310FF] hover:text-white"
