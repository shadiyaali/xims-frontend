...
import "./subscriberblockerror.css";
import { useTheme } from '../../../ThemeContext';
import errors from "../../../assets/images/Modal/errors.svg";
import { motion, AnimatePresence } from "framer-motion";

const SubscriberBlockErrorModal = ({ showSubscriberBlockErrorModal, onClose }) => {
    const { theme } = useTheme();
  
    if (!showSubscriberBlockErrorModal) return null;
    return (
      <AnimatePresence>
        {showSubscriberBlockErrorModal && (
          <motion.div
...
export default SubscriberBlockErrorModal
