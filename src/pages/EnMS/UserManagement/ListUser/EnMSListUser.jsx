    ...
    <div className="bg-[#1C1C24] list-users-main">
      ...
      <div className="flex items-center justify-between px-[14px] pt-[24px]">
        ...
        <div className="flex space-x-5">
          ...
          <button
            className="flex items-center justify-center add-user-btn gap-[10px] duration-200 border border-[#10B8FF] text-[#10B8FF] hover:bg-[#10B8FF] hover:text-white"
